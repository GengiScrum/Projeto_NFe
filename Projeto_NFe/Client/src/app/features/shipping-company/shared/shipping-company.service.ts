...
import { ShippingCompany, ShippingCompanyRegisterCommand } from './shipping-company.model';
...
export class ShippingCompanyService extends BaseService {
    ...
    public post(shippingCompanyRegisterCommand: ShippingCompanyRegisterCommand): Observable<boolean> {
        return this.http.post(`${this.api}`, shippingCompanyRegisterCommand)
